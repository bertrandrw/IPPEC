...
export const listPendingUsersController = catchAsync(async (req, res) => {
    const users = await adminService.listPendingUsers();
    res.status(StatusCodes.OK).json(new ApiResponse(StatusCodes.OK, users));
});
export const approveUserController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id) {
...
export const createHospitalController = catchAsync(async (req, res) => {
...
export const createPharmacyController = catchAsync(async (req, res) => {
...
export const createDoctorController = catchAsync(async (req, res) => {
...
export const listAllMedicinesController = catchAsync(async (req, res) => {
...
export const createInsurerController = catchAsync(async (req, res) => {
