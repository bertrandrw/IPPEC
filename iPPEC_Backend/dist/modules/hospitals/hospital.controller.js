...
export const listHospitalsController = catchAsync(async (req, res) => {
...
export const getHospitalByIdController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Hospital ID is required.');
...
export const updateHospitalController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Hospital ID is required.');
...
export const deleteHospitalController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Hospital ID is required.');
