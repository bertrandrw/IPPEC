...
export const generateClaimReportController = catchAsync(async (req, res) => {
...
export const createInsuranceCompanyController = catchAsync(async (req, res) => {
...
export const listInsuranceCompaniesController = catchAsync(async (req, res) => {
...
export const getInsuranceCompanyByIdController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
...
export const updateInsuranceCompanyController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Company ID is required.');
...
export const deleteInsuranceCompanyController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Company ID is required.');
