...
export const createPharmacistController = catchAsync(async (req, res) => {
...
export const getPharmacistByIdController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Pharmacist ID is required.');
...
export const updatePharmacistController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Pharmacist ID is required.');
...
export const deletePharmacistController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id)
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Pharmacist ID is required.');
