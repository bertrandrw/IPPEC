 ...
 */
export const createPharmacist = async (input) => {
 ...
 */
export const getPharmacistById = async (pharmacistUserId) => {
 ...
 */
export const updatePharmacist = async (pharmacistUserId, input) => {
 ...
 */
export const deletePharmacist = async (pharmacistUserId) => {
