...
export const createPrescriptionController = catchAsync(async (req, res) => {
...
export const listMyPrescriptionsController = catchAsync(async (req, res) => {
...
export const getMyPrescriptionByIdController = catchAsync(async (req, res) => {
    const patientUser = req.user;
    const { id } = req.params;
    if (!id) {
...
export const getPrescriptionForFulfillmentController = catchAsync(async (req, res) => {
    const { id } = req.params;
    if (!id) {
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Prescription ID is required.');
    }
...
export const fulfillPrescriptionController = catchAsync(async (req, res) => {
...
export const listMyPrescriptionsForDoctorController = catchAsync(async (req, res) => {
    const doctorUser = req.user;
...
export const listPatientPrescriptionsForDoctorController = catchAsync(async (req, res) => {
...
export const getPrescriptionByIdController = catchAsync(async (req, res) => {
    const user = req.user;
    const { id } = req.params;
    if (!id) {
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Prescription ID is required.');
...
export const updateMyPrescriptionController = catchAsync(async (req, res) => {
    const doctorUser = req.user;
    const { id } = req.params;
    if (!id) {
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Prescription ID is required.');
 ...
 */
export const cancelMyPrescriptionController = catchAsync(async (req, res) => {
    const doctorUser = req.user;
    const { id } = req.params;
    if (!id) {
        throw new ApiError(StatusCodes.BAD_REQUEST, 'Prescription ID is required.');
...
export const findPharmaciesForPrescriptionController = catchAsync(async (req, res) => {
    const patientUser = req.user;
