...
type CreateCompanyInput = z.infer<typeof createInsuranceCompanyDto>['body'];
type UpdateCompanyInput = z.infer<typeof updateInsuranceCompanyDto>['body'];
...
export const createInsuranceCompany = async (input: CreateCompanyInput) => {
...
export const listInsuranceCompanies = async (page: number, limit: number) => {
...
// --- READ (Get One by ID) ---
export const getInsuranceCompanyById = async (companyId: string) => {
...
// --- UPDATE ---
export const updateInsuranceCompany = async (companyId: string, input: UpdateCompanyInput) => {
...
// --- DELETE ---
export const deleteInsuranceCompany = async (companyId: string) => {
  await getInsuranceCompanyById(companyId); // Ensure it exists
