...
const createListController = (serviceFunction: (params: { page: number; limit: number; }) => Promise<{ data: any[]; totalCount: number; }>) => {
  return catchAsync(async (req: IAuthRequest, res: Response) => {
